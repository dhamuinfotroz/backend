-- UPSC Prelims Summary - FINAL CORRECT VERSION
-- Preserves exact document structure
-- No smart mapping - just sequential extraction
...
INSERT INTO categories (id, title, slug, order_index) VALUES (2, 'PAPER --II (CSAT)', 'paper-ii-csat', 1);
...
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (4, 1, 'Visual Arts', 'visual-arts', 'Study material for Visual Arts', 3);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (5, 1, 'Performing Arts', 'performing-arts', 'Study material for Performing Arts', 4);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (6, 1, 'Religion, Language and Literature', 'religion-language-and-literature', 'Study material for Religion, Language and Literature', 5);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (7, 1, 'Miscellaneous', 'miscellaneous', 'Study material for Miscellaneous', 6);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (8, 1, 'Oceanography', 'oceanography', 'Study material for Oceanography', 7);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (9, 1, 'Climatology', 'climatology', 'Study material for Climatology', 8);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (10, 1, 'Bio-Geography', 'bio-geography', 'Study material for Bio-Geography', 9);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (11, 1, 'Human & Economic Geography of the World', 'human-economic-geography-of-the-world', 'Study material for Human & Economic Geography of the World', 10);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (12, 1, 'Indian Geography', 'indian-geography', 'Study material for Indian Geography', 11);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (13, 1, 'World Regional Geography', 'world-regional-geography', 'Study material for World Regional Geography', 12);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (14, 1, 'Environmental Ecology', 'environmental-ecology', 'Study material for Environmental Ecology', 13);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (15, 1, 'Biodiversity', 'biodiversity', 'Study material for Biodiversity', 14);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (16, 1, 'RESOURCE DEGRADATION AND MANAGEMENT', 'resource-degradation-and-management', 'Study material for RESOURCE DEGRADATION AND MANAGEMENT', 15);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (17, 1, 'ENVIRONMENTAL POLLUTION', 'environmental-pollution', 'Study material for ENVIRONMENTAL POLLUTION', 16);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (18, 1, 'CLIMATE CHANGE', 'climate-change', 'Study material for CLIMATE CHANGE', 17);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (19, 1, 'ENVIRONMENTAL GOVERNANCE', 'environmental-governance', 'Study material for ENVIRONMENTAL GOVERNANCE', 18);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (20, 1, 'Evolution of the Constitution', 'evolution-of-the-constitution', 'Study material for Evolution of the Constitution', 19);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (21, 1, 'Salient Features of the Indian Constitution', 'salient-features-of-the-indian-constitution', 'Study material for Salient Features of the Indian Constitution', 20);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (22, 1, 'Union & Its Territory', 'union-its-territory', 'Study material for Union & Its Territory', 21);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (23, 1, 'CITIZENSHIP', 'citizenship', 'Study material for CITIZENSHIP', 22);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (24, 1, 'SYSTEM OF GOVERNANCE', 'system-of-governance', 'Study material for SYSTEM OF GOVERNANCE', 23);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (25, 1, 'UNION EXECUTIVE', 'union-executive', 'Study material for UNION EXECUTIVE', 24);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (26, 1, 'LOCAL GOVERNMENT', 'local-government', 'Study material for LOCAL GOVERNMENT', 25);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (27, 1, 'THE JUDICIARY', 'the-judiciary', 'Study material for THE JUDICIARY', 26);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (28, 1, 'CONSTITUTIONAL AND NON CONSTITUTIONAL BODIES', 'constitutional-and-non-constitutional-bodies', 'Study material for CONSTITUTIONAL AND NON CONSTITUTIONAL BODIES', 27);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (29, 1, 'BASIC CONCEPTS', 'basic-concepts', 'Study material for BASIC CONCEPTS', 28);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (30, 1, 'OPEN ECONOMY', 'open-economy', 'Study material for OPEN ECONOMY', 29);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (31, 1, 'ECONOMIC SECTORS', 'economic-sectors', 'Study material for ECONOMIC SECTORS', 30);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (32, 1, 'Science and Technology in India', 'science-and-technology-in-india', 'Study material for Science and Technology in India', 31);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (33, 1, 'Space', 'space', 'Study material for Space', 32);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (34, 1, 'IT AND COMMUNICATION', 'it-and-communication', 'Study material for IT AND COMMUNICATION', 33);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (35, 1, 'MATERIALS, NANO TECHNOLOGY AND ROBOTICS', 'materials-nano-technology-and-robotics', 'Study material for MATERIALS, NANO TECHNOLOGY AND ROBOTICS', 34);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (36, 1, 'DEFENCE', 'defence', 'Study material for DEFENCE', 35);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (37, 1, 'NUCLEAR TECHNOLOGY', 'nuclear-technology', 'Study material for NUCLEAR TECHNOLOGY', 36);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (38, 1, 'IPR AND OTHER MISCELLANEOUS ISSUES', 'ipr-and-other-miscellaneous-issues', 'Study material for IPR AND OTHER MISCELLANEOUS ISSUES', 37);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (39, 1, 'BIOTECHNOLOGY', 'biotechnology', 'Study material for BIOTECHNOLOGY', 38);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (40, 2, 'Interpersonal Skills including Communication Skills', 'interpersonal-skills-including-communication-skills', 'Study material for Interpersonal Skills including Communication Skills', 0);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (41, 2, 'Logical Reasoning and Analytical Ability', 'logical-reasoning-and-analytical-ability', 'Study material for Logical Reasoning and Analytical Ability', 1);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (42, 2, 'Decision Making and Problem Solving', 'decision-making-and-problem-solving', 'Study material for Decision Making and Problem Solving', 2);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (43, 2, 'General Mental Ability', 'general-mental-ability', 'Study material for General Mental Ability', 3);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (44, 2, 'Basic Numeracy (Class X Level)', 'basic-numeracy-class-x-level', 'Study material for Basic Numeracy (Class X Level)', 4);
INSERT INTO topics (id, category_id, title, slug, description, order_index) VALUES (45, 2, 'Data Interpretation (Class X Level)', 'data-interpretation-class-x-level', 'Study material for Data Interpretation (Class X Level)', 5);

-- Contents
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (1, 1, 'Prehistoric Times', 'prehistoric-times', '<h2>Prehistoric Times</h2>
...
<p>early humans in the Indian subcontinent.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (2, 1, 'Indus Valley Civilization', 'indus-valley-civilization', '<h2>Indus Valley Civilization</h2>
...
<p>climatic factors.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (3, 1, 'Rig Vedic Period', 'rig-vedic-period', '<h2>Rig Vedic Period</h2>
...
<p>egalitarian and simple in nature.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (4, 1, 'Later Vedic Period', 'later-vedic-period', '<h2>Later Vedic Period</h2>
...
<p>movements like Buddhism and Jainism.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (5, 1, 'Jainism', 'jainism', '<h2>Jainism</h2>
...
<p>in Indian society.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (6, 1, 'Buddhism', 'buddhism', '<h2>Buddhism</h2>
...
<p>architecture, and ethics.</p>', 5);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (7, 1, 'Mahajanapadas Period', 'mahajanapadas-period', '<h2>Mahajanapadas Period</h2>
...
<p>Mauryan Empire.</p>', 6);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (8, 1, 'Mauryan Empire', 'mauryan-empire', '<h2>Mauryan Empire</h2>
...
<p>weak successors and administrative difficulties.</p>', 7);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (9, 1, 'Post-Mauryan India', 'post-mauryan-india', '<h2>Post-Mauryan India</h2>
...
<p>often called the "Golden Age" of India.</p>', 8);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (10, 1, 'Gupta Period', 'gupta-period', '<h2>Gupta Period</h2>
...
<p>lasting impact on Indian culture, politics, and intellectual traditions.</p>', 9);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (11, 1, 'Harshavardhana Period', 'harshavardhana-period', '<h2>Harshavardhana Period</h2>
...
<p>post-Gupta era.</p>', 10);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (12, 1, 'Sangam Period (South Indian Dynasties)', 'sangam-period-south-indian-dynasties', '<h2>Sangam Period (South Indian Dynasties)</h2>
...
<p>foundation for later South Indian kingdoms and cultural developments.</p>', 11);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (13, 2, 'Major Dynasties (750--1200 CE) of Early Medieval India', 'major-dynasties-750-1200-ce-of-early-medieval-india', '<h2>Major Dynasties (750--1200 CE) of Early Medieval India</h2>
...
<p>shaping medieval Indian history.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (14, 2, 'Cholas and Other South Indian Kingdoms', 'cholas-and-other-south-indian-kingdoms', '<h2>Cholas and Other South Indian Kingdoms</h2>
...
<p>architecture.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (15, 2, 'Early Muslim Invasions', 'early-muslim-invasions', '<h2>Early Muslim Invasions</h2>
<p>The Early Muslim invasions marked the beginning of Islamic political and</p>
<p>cultural contact with India. The first major invasion was led by</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (16, 2, 'Muhammad bin Qasim in 712 CE, resulting in the conquest of Sindh', 'muhammad-bin-qasim-in-712-ce-resulting-in-the-conquest-of-sindh', '<h2>Muhammad bin Qasim in 712 CE, resulting in the conquest of Sindh</h2>
...
<p>long-term cultural interactions between India and the Islamic world.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (17, 2, 'The Delhi Sultanate (1206--1526 AD)', 'the-delhi-sultanate-1206-1526-ad', '<h2>The Delhi Sultanate (1206--1526 AD)</h2>
...
<p>paving the way for the Mughal Empire.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (18, 2, 'Struggle for Empire in North India (Afghans, Rajputs, and Mughals)', 'struggle-for-empire-in-north-india-afghans-rajputs-and-mughals', '<h2>Struggle for Empire in North India (Afghans, Rajputs, and Mughals)</h2>
...
<p>Empire''s expansion</p>', 5);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (19, 2, 'The Establishment of the North Indian Empire', 'the-establishment-of-the-north-indian-empire', '<h2>The Establishment of the North Indian Empire</h2>
...
<p>and architectural achievements.</p>', 6);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (20, 2, 'Consolidation and Expansion of the Empire -- Akbar', 'consolidation-and-expansion-of-the-empire-akbar', '<h2>Consolidation and Expansion of the Empire -- Akbar</h2>
...
<p>prosperous state.</p>', 7);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (21, 2, 'State and Government under Akbar', 'state-and-government-under-akbar', '<h2>State and Government under Akbar</h2>
<p>Akbar established a highly **centralized and efficient administrative</p>
<p>system** to govern the Mughal Empire. The empire was divided into</p>', 8);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (22, 2, 'subahs (provinces), each headed by a subahdar (governor),', 'subahs-provinces-each-headed-by-a-subahdar-governor', '<h2>subahs (provinces), each headed by a subahdar (governor),</h2>
...
<p>stability and expansion.</p>', 9);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (23, 2, 'Akbar''s Religious Views', 'akbars-religious-views', '<h2>Akbar''s Religious Views</h2>
...
<p>synthesis** in Indian history.</p>', 10);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (24, 2, 'The Deccan and the Mughals (Up to 1657)', 'the-deccan-and-the-mughals-up-to-1657', '<h2>The Deccan and the Mughals (Up to 1657)</h2>
...
<p>conflicts with the emerging **Maratha power** after 1657.</p>', 11);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (25, 2, 'Foreign Policy of the Mughals', 'foreign-policy-of-the-mughals', '<h2>Foreign Policy of the Mughals</h2>
...
<p>stability and regional supremacy.</p>', 12);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (26, 2, 'India in the First Half of the Seventeenth Century (1600--1657)', 'india-in-the-first-half-of-the-seventeenth-century-1600-1657', '<h2>India in the First Half of the Seventeenth Century (1600--1657)</h2>
...
<p>India.</p>', 13);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (27, 2, 'Climax and Crisis of the Mughal Empire: The Marathas and the Deccan', 'climax-and-crisis-of-the-mughal-empire-the-marathas-and-the-deccan', '<h2>Climax and Crisis of the Mughal Empire: The Marathas and the Deccan</h2>
...
<p>consolidating power** in western and central India.</p>', 14);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (28, 2, 'The Marathas and Other Indian States and Society in the 18th Century', 'the-marathas-and-other-indian-states-and-society-in-the-18th-century', '<h2>The Marathas and Other Indian States and Society in the 18th Century</h2>
...
<p>eventual British dominance by the late 18th century.</p>', 15);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (29, 2, 'Vijayanagar Empire', 'vijayanagar-empire', '<h2>Vijayanagar Empire</h2>
...
<p>powers continued under Vijayanagar legacy.</p>', 16);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (30, 2, 'Regional States in the Medieval Period', 'regional-states-in-the-medieval-period', '<h2>Regional States in the Medieval Period</h2>
...
<p>the Mughals.</p>', 17);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (31, 2, 'Northern India in the First Half of the Eighteenth Century', 'northern-india-in-the-first-half-of-the-eighteenth-century', '<h2>Northern India in the First Half of the Eighteenth Century</h2>
...
<p>India.</p>', 18);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (32, 2, 'Society -- Structure and Growth', 'society-structure-and-growth', '<h2>Society -- Structure and Growth</h2>
...
<p>change.</p>', 19);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (33, 2, 'Economic Life-Patterns and Prospects', 'economic-life-patterns-and-prospects', '<h2>Economic Life-Patterns and Prospects</h2>
...
<p>expansion.**</p>
<p>Top of Form</p>
<p>Bottom of Form</p>', 20);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (34, 3, 'The Advent of Europeans In India', 'the-advent-of-europeans-in-india', '<h2>The Advent of Europeans In India</h2>
...
<p>the stage for later British dominance.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (35, 3, 'British Expansion in India', 'british-expansion-in-india', '<h2>British Expansion in India</h2>
...
<p>1858.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (36, 3, 'Administration before 1857', 'administration-before-1857', '<h2>Administration before 1857</h2>
...
<p>1857. The revolt marked the end of Company rule and the beginning of</p>
<p>direct British Crown administration in India.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (37, 3, 'Economic Policies of The British', 'economic-policies-of-the-british', '<h2>Economic Policies of The British</h2>
...
<p>movements and demands for self-rule.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (38, 3, 'Impact of British Administration', 'impact-of-british-administration', '<h2>Impact of British Administration</h2>
...
<p>widespread discontent and eventually the struggle for independence.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (39, 3, 'The Revolt Of 1857', 'the-revolt-of-1857', '<h2>The Revolt Of 1857</h2>
...
<p>organized resistance and inspired later freedom movements.</p>', 5);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (40, 3, 'Administrative Changes After 1857', 'administrative-changes-after-1857', '<h2>Administrative Changes After 1857</h2>
...
<p>consolidating imperial control and preventing further revolts.</p>', 6);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (41, 3, 'Development of Civil Services', 'development-of-civil-services', '<h2>Development of Civil Services</h2>
...
<p>origin, structure, recruitment, and role in administration.</p>', 7);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (42, 3, 'Development of Education', 'development-of-education', '<h2>Development of Education</h2>
...
<p>universities.</p>', 8);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (43, 3, 'Development of Press', 'development-of-press', '<h2>Development of Press</h2>
...
<p>like the Vernacular Press Act.</p>', 9);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (44, 3, 'Socio-Religious Reforms', 'socio-religious-reforms', '<h2>Socio-Religious Reforms</h2>
...
<p>reforms.</p>', 10);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (45, 3, 'Personalities', 'personalities', '<h2>Personalities</h2>
...
<p>nationalism.</p>', 11);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (46, 3, 'Peasant, Tribal and Other Movements', 'peasant-tribal-and-other-movements', '<h2>Peasant, Tribal and Other Movements</h2>', 12);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (47, 3, 'Peasant Movements:', 'peasant-movements', '<h2>Peasant Movements:</h2>
<p>1.  Santhal Rebellion (1855--1856) -- Led by Sidhu and Kanhu, against</p>
<p>exploitation by landlords and moneylenders in Bengal and Bihar.</p>
<p>2.  Pabna Uprising (1873--1876) -- In Bengal, peasants protested against</p>
<p>oppressive landlords (*zamindars*).</p>
<p>3.  Deccan Riots (1875) -- Peasants in Maharashtra revolted against high</p>
<p>debts and moneylenders.</p>
<p>4.  Bardoli Satyagraha (1928) -- Led by Sardar Vallabhbhai Patel in</p>
<p>Gujarat against increased revenue demands.</p>', 13);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (48, 3, 'Tribal Movements:', 'tribal-movements', '<h2>Tribal Movements:</h2>
<p>1.  Bhils, Gonds, and Mundas -- Resisted British forest policies, forced</p>
<p>labor, and land alienation.</p>
<p>2.  Munda Rebellion (1899--1900) -- Led by Birsa Munda in Chotanagpur</p>
<p>against exploitative landlords and British policies.</p>
<p>3.  Santhal Hool -- Included tribal resistance to land dispossession and</p>
<p>revenue exploitation.</p>', 14);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (49, 3, 'Other Movements:', 'other-movements', '<h2>Other Movements:</h2>
<p>1.  Peasant and tribal revolts often merged with social and religious</p>
<p>causes, including anti-colonial resistance.</p>
<p>2.  Movements reflected regional variations but shared common goals of</p>
<p>defending land, resources, and traditional rights.</p>
<p>3.  These uprisings laid the foundation for later organized nationalist</p>
<p>movements.</p>', 15);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (50, 3, 'Revolutionary Nationalism', 'revolutionary-nationalism', '<h2>Revolutionary Nationalism</h2>
...
<p>leaders, organizations, events, and regional significance.</p>', 16);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (51, 3, 'Indian National Movement -- I (1905-1918)', 'indian-national-movement-i-1905-1918', '<h2>Indian National Movement -- I (1905-1918)</h2>
...
<p>Extremist leaders, revolutionary activities, and key reforms.</p>', 17);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (52, 3, 'Indian National Movement --II (1918-1929)', 'indian-national-movement-ii-1918-1929', '<h2>Indian National Movement --II (1918-1929)</h2>
...
<p>constitutional developments.</p>', 18);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (53, 3, 'Indian National Movement -- III (1930-1947)', 'indian-national-movement-iii-1930-1947', '<h2>Indian National Movement -- III (1930-1947)</h2>
...
<p>key leaders, and independence events.</p>', 19);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (54, 3, 'Governor Generals During British India', 'governor-generals-during-british-india', '<h2>Governor Generals During British India</h2>
...
<p>**Warren Hastings (1773--1785)** -- First Governor-General of Bengal</p>
...
<p>**Lord Hastings (1813--1823)** -- Consolidated British control in India;</p>
...
<p>independence and partition of India.</p>', 20);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (55, 3, 'Constitutional Development in India', 'constitutional-development-in-india', '<h2>Constitutional Development in India</h2>
...
<p>governance and Indian participation.</p>', 21);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (56, 3, 'INDIAN CULTURE', 'indian-culture', '<h2>INDIAN CULTURE</h2>', 22);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (57, 4, 'Architecture', 'architecture', '<h2>Architecture</h2>
...
<p>adaptation, and cultural synthesis.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (58, 4, 'Sculptures', 'sculptures', '<h2>Sculptures</h2>
...
<p>artistic continuity and cultural diversity.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (59, 4, 'Paintings', 'paintings', '<h2>Paintings</h2>
...
<p>artistic continuity.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (60, 4, 'Pottery Tradition', 'pottery-tradition', '<h2>Pottery Tradition</h2>
...
<p>source for Indian history.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (61, 4, 'Numismatics', 'numismatics', '<h2>Numismatics</h2>
...
<p>understanding chronology and administration.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (62, 5, 'Music in India', 'music-in-india', '<h2>Music in India</h2>
...
<p>to be a vital part of India''s cultural heritage.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (63, 5, 'Dances in India', 'dances-in-india', '<h2>Dances in India</h2>
...
<p>heritage.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (64, 5, 'Sports in India', 'sports-in-india', '<h2>Sports in India</h2>
...
<p>competitive spirit.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (65, 5, 'Indian Theatre', 'indian-theatre', '<h2>Indian Theatre</h2>
...
<p>cultural heritage.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (66, 5, 'Indian Puppetry', 'indian-puppetry', '<h2>Indian Puppetry</h2>
...
<p>culture and oral traditions.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (67, 6, 'Religions in-India', 'religions-in-india', '<h2>Religions in-India</h2>
...
<p>social practices.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (68, 6, 'Languages and Literature in India', 'languages-and-literature-in-india', '<h2>Languages and Literature in India</h2>
...
<p>themes, contributing to art, culture, and social reform.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (69, 7, 'Recent developments', 'recent-developments', '<h2>Recent developments</h2>
...
<p>diplomatic and economic role.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (70, 7, 'GEOGRAPHY', 'geography', '<h2>GEOGRAPHY</h2>
<p>**\</p>
<p>1. General Geography**\</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (71, 7, 'Universe', 'universe', '<h2>Universe</h2>
...
<p>for conceptual questions in UPSC Prelims.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (72, 7, 'Earth''s Evolution', 'earths-evolution', '<h2>Earth''s Evolution</h2>
...
<p>prelims.</p>
<p>**2. Geomorphology**\</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (73, 7, 'Earth''s Interior', 'earths-interior', '<h2>Earth''s Interior</h2>
...
<p>essential for conceptual and application-based prelims questions.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (74, 7, 'Geology and Rock System', 'geology-and-rock-system', '<h2>Geology and Rock System</h2>
...
<p>for UPSC Prelims.</p>', 5);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (75, 7, 'Geomorphic Processes', 'geomorphic-processes', '<h2>Geomorphic Processes</h2>
...
<p>This topic is important for both static and map-based prelims questions.</p>', 6);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (76, 7, 'Earthquakes and Volcanism', 'earthquakes-and-volcanism', '<h2>Earthquakes and Volcanism</h2>
...
<p>disaster-related prelims questions.</p>', 7);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (77, 7, 'Distribution of Continents and Oceans', 'distribution-of-continents-and-oceans', '<h2>Distribution of Continents and Oceans</h2>
...
<p>patterns. It is useful for conceptual and map-based prelims questions.</p>', 8);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (78, 7, 'Landforms and Their Evolution', 'landforms-and-their-evolution', '<h2>Landforms and Their Evolution</h2>
...
<p>from maps and images. It is a core area in prelims.</p>', 9);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (79, 7, 'Landforms Across the World', 'landforms-across-the-world', '<h2>Landforms Across the World</h2>
...
<p>questions.</p>', 10);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (80, 8, 'Hydrosphere', 'hydrosphere', '<h2>Hydrosphere</h2>
...
<p>systems. It is essential for conceptual clarity in prelims.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (81, 8, 'Submarine Relief Features', 'submarine-relief-features', '<h2>Submarine Relief Features</h2>
...
<p>important for map-based and conceptual prelims questions.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (82, 8, 'Temperature and Salinity', 'temperature-and-salinity', '<h2>Temperature and Salinity</h2>
...
<p>is crucial for understanding climate patterns and ocean dynamics.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (83, 8, 'Waves, Ocean Currents, and Tides', 'waves-ocean-currents-and-tides', '<h2>Waves, Ocean Currents, and Tides</h2>
...
<p>El Niño and La Niña. It is frequently asked in prelims.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (84, 8, 'Marine Resources', 'marine-resources', '<h2>Marine Resources</h2>
...
<p>prelims.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (85, 8, 'Ocean Deposits and Corals', 'ocean-deposits-and-corals', '<h2>Ocean Deposits and Corals</h2>
...
<p>topic is important for environment-related prelims questions.</p>', 5);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (86, 9, 'Atmosphere', 'atmosphere', '<h2>Atmosphere</h2>
...
<p>conceptual questions in UPSC Prelims.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (87, 9, 'Inversion of Temperature', 'inversion-of-temperature', '<h2>Inversion of Temperature</h2>
...
<p>geography.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (88, 9, 'Insolation and Heat Budget', 'insolation-and-heat-budget', '<h2>Insolation and Heat Budget</h2>
...
<p>important for conceptual clarity in UPSC Prelims.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (89, 9, 'Winds and Pressure Belts', 'winds-and-pressure-belts', '<h2>Winds and Pressure Belts</h2>
...
<p>asked in UPSC Prelims.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (90, 9, 'Air Masses, Fronts, Cyclones and Jet Stream', 'air-masses-fronts-cyclones-and-jet-stream', '<h2>Air Masses, Fronts, Cyclones and Jet Stream</h2>
...
<p>questions.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (91, 9, 'Precipitation', 'precipitation', '<h2>Precipitation</h2>
...
<p>closely linked with Indian monsoon questions in UPSC Prelims.</p>', 5);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (92, 9, 'Climatic Zones of the World', 'climatic-zones-of-the-world', '<h2>Climatic Zones of the World</h2>
...
<p>UPSC Prelims.</p>', 6);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (93, 10, 'Soil Characteristics', 'soil-characteristics', '<h2>Soil Characteristics</h2>
...
<p>UPSC Prelims.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (94, 10, 'Vegetation Resources', 'vegetation-resources', '<h2>Vegetation Resources</h2>
...
<p>and sustainable development. It is highly relevant for UPSC Prelims.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (95, 11, 'Demography and Census', 'demography-and-census', '<h2>Demography and Census</h2>
...
<p>is important for analytical prelims questions.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (96, 11, 'Human Development', 'human-development', '<h2>Human Development</h2>
...
<p>UPSC Prelims.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (97, 11, 'Economic Activities', 'economic-activities', '<h2>Economic Activities</h2>
...
<p>for both static and current affairs-based prelims questions.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (98, 11, 'Transport and Communication', 'transport-and-communication', '<h2>Transport and Communication</h2>
...
<p>questions.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (99, 11, 'International Trade', 'international-trade', '<h2>International Trade</h2>
...
<p>questions.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (100, 11, 'Settlement', 'settlement', '<h2>Settlement</h2>
...
<p>conceptual and application-based prelims questions.</p>', 5);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (101, 12, 'Physiography of India', 'physiography-of-india', '<h2>Physiography of India</h2>
...
<p>Indian geography in prelims.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (102, 12, 'Drainage System', 'drainage-system', '<h2>Drainage System</h2>
...
<p>prelims questions.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (103, 13, 'Continents, Countries and Cities', 'continents-countries-and-cities', '<h2>Continents, Countries and Cities</h2>
...
<p>prelims questions.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (104, 13, 'Location in News', 'location-in-news', '<h2>Location in News</h2>
...
<p>scoring areas in UPSC Prelims.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (105, 13, 'ECOLOGY & ENVIRONMENT', 'ecology-environment', '<h2>ECOLOGY & ENVIRONMENT</h2>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (106, 14, 'Origin of Life Forms', 'origin-of-life-forms', '<h2>Origin of Life Forms</h2>
...
<p>Origin of life forms the base of ecology.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (107, 14, 'Basic Concepts of Ecology', 'basic-concepts-of-ecology', '<h2>Basic Concepts of Ecology</h2>
...
<p>support conservation. They are fundamental to environmental science.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (108, 14, 'Ecosystem Functions', 'ecosystem-functions', '<h2>Ecosystem Functions</h2>
...
<p>ensures sustainability.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (109, 14, 'Population Ecology', 'population-ecology', '<h2>Population Ecology</h2>
...
<p>Population studies are essential for sustainability.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (110, 14, 'Adaptation of Species and Interactions', 'adaptation-of-species-and-interactions', '<h2>Adaptation of Species and Interactions</h2>
...
<p>ecosystem resilience.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (111, 14, 'Terrestrial Ecosystems', 'terrestrial-ecosystems', '<h2>Terrestrial Ecosystems</h2>
...
<p>soil erosion. Healthy land ecosystems ensure sustainability.</p>', 5);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (112, 14, 'Aquatic Ecosystems', 'aquatic-ecosystems', '<h2>Aquatic Ecosystems</h2>
...
<p>support global water cycles. Healthy waters ensure survival.</p>', 6);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (113, 14, 'Nutrient Cycling', 'nutrient-cycling', '<h2>Nutrient Cycling</h2>
...
<p>cycling ensures continuity. It is essential for ecosystem health.</p>', 7);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (114, 15, 'Basics of Biodiversity', 'basics-of-biodiversity', '<h2>Basics of Biodiversity</h2>
...
<p>ecological balance.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (115, 15, 'Animal and Plant Diversity', 'animal-and-plant-diversity', '<h2>Animal and Plant Diversity</h2>
...
<p>and plant diversity ensures ecosystem stability.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (116, 15, 'Threats to Biodiversity', 'threats-to-biodiversity', '<h2>Threats to Biodiversity</h2>
...
<p>reduces pressure. Protecting biodiversity is urgent.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (117, 15, 'Biodiversity Conservation', 'biodiversity-conservation', '<h2>Biodiversity Conservation</h2>
...
<p>conservation. Biodiversity conservation ensures future survival.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (118, 15, 'Estuaries', 'estuaries', '<h2>Estuaries</h2>
...
<p>valuable ecosystems.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (119, 15, 'Mangroves', 'mangroves', '<h2>Mangroves</h2>
...
<p>ecological balance. Preservation is environmentally crucial.</p>', 5);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (120, 15, 'Coral Reef', 'coral-reef', '<h2>Coral Reef</h2>
...
<p>important.</p>', 6);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (121, 15, 'Wetlands', 'wetlands', '<h2>Wetlands</h2>
...
<p>wetlands ensures sustainability.</p>', 7);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (122, 16, 'Land Resource', 'land-resource', '<h2>Land Resource</h2>
...
<p>Restoration improves land quality. Sustainable land use is essential.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (123, 16, 'Forest Resource', 'forest-resource', '<h2>Forest Resource</h2>
...
<p>resources are environmentally critical.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (124, 16, 'Soil Resource', 'soil-resource', '<h2>Soil Resource</h2>
...
<p>protects future food security.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (125, 16, 'Water Pollution', 'water-pollution', '<h2>Water Pollution</h2>
...
<p>ensures water security. Clean water is essential for life.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (126, 16, 'Energy Resources', 'energy-resources', '<h2>Energy Resources</h2>
...
<p>energy ensures future sustainability.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (127, 17, 'Basics of Pollution', 'basics-of-pollution', '<h2>Basics of Pollution</h2>
...
<p>Managing pollution ensures environmental safety.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (128, 17, 'Mining and Pollution', 'mining-and-pollution', '<h2>Mining and Pollution</h2>
...
<p>is essential.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (129, 17, 'Air Pollution', 'air-pollution', '<h2>Air Pollution</h2>
...
<p>for health.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (130, 17, 'Marine Pollution', 'marine-pollution', '<h2>Marine Pollution</h2>
...
<p>fishing reduces damage. Marine conservation ensures ocean health.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (131, 17, 'Noise Pollution', 'noise-pollution', '<h2>Noise Pollution</h2>
...
<p>healthy living.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (132, 17, 'Biological Pollution', 'biological-pollution', '<h2>Biological Pollution</h2>
...
<p>Managing biological pollution is crucial.</p>', 5);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (133, 17, 'Radioactive Pollution', 'radioactive-pollution', '<h2>Radioactive Pollution</h2>
...
<p>Preventing radioactive pollution is critical.</p>', 6);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (134, 17, 'Thermal Pollution', 'thermal-pollution', '<h2>Thermal Pollution</h2>
...
<p>aquatic life.</p>', 7);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (135, 17, 'Waste Management', 'waste-management', '<h2>Waste Management</h2>
...
<p>cleanliness.</p>', 8);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (136, 18, 'Climate Change Basics', 'climate-change-basics', '<h2>Climate Change Basics</h2>
...
<p>is essential. Climate awareness is crucial.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (137, 18, 'Climate Change Impact', 'climate-change-impact', '<h2>Climate Change Impact</h2>
...
<p>resilience.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (138, 19, 'Acts and Policies', 'acts-and-policies', '<h2>Acts and Policies</h2>
...
<p>improves implementation. Strong laws ensure sustainability.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (139, 19, 'Environmental Impact Assessment (EIA)', 'environmental-impact-assessment-eia', '<h2>Environmental Impact Assessment (EIA)</h2>
...
<p>development.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (140, 19, 'International Environmental Governance', 'international-environmental-governance', '<h2>International Environmental Governance</h2>
...
<p>Global governance is essential.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (141, 19, 'India and Climate Change', 'india-and-climate-change', '<h2>India and Climate Change</h2>
...
<p>significant.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (142, 19, 'Environment-Related Institutions in India', 'environment-related-institutions-in-india', '<h2>Environment-Related Institutions in India</h2>
...
<p>institutions ensure sustainability.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (143, 19, 'Environmental Schemes in India', 'environmental-schemes-in-india', '<h2>Environmental Schemes in India</h2>
...
<p>with SDGs. Government action drives sustainability.</p>', 5);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (144, 19, 'APPENDIX', 'appendix', '<h2>APPENDIX</h2>
...
<p>documentation.</p>', 6);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (145, 19, 'Recent Developments', 'recent-developments', '<h2>Recent Developments</h2>
...
<p>policy.</p>', 7);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (146, 19, 'INDIAN POLITY & GOVERNANCE', 'indian-polity-governance', '<h2>INDIAN POLITY & GOVERNANCE</h2>', 8);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (147, 20, 'Company Rule (1773--1858)', 'company-rule-1773-1858', '<h2>Company Rule (1773--1858)</h2>
...
<p>rule ended after 1857 revolt.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (148, 20, 'Crown Rule (1858--1947)', 'crown-rule-1858-1947', '<h2>Crown Rule (1858--1947)</h2>
...
<p>1947.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (149, 20, 'Drafting and Sources of Indian Constitution', 'drafting-and-sources-of-indian-constitution', '<h2>Drafting and Sources of Indian Constitution</h2>
...
<p>reflects collective wisdom. Drafting ensured inclusive governance.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (150, 21, 'Constitution and Types', 'constitution-and-types', '<h2>Constitution and Types</h2>
...
<p>A constitution guides governance and justice.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (151, 21, 'Types of Political System', 'types-of-political-system', '<h2>Types of Political System</h2>
...
<p>and federalism.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (152, 21, 'Types of Majorities as per the Indian Constitution', 'types-of-majorities-as-per-the-indian-constitution', '<h2>Types of Majorities as per the Indian Constitution</h2>
...
<p>essential for governance. They ensure legitimacy of decisions.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (153, 21, 'Preamble and Values in the Constitution', 'preamble-and-values-in-the-constitution', '<h2>Preamble and Values in the Constitution</h2>
...
<p>the soul of the Constitution.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (154, 21, 'Amendment of the Constitution', 'amendment-of-the-constitution', '<h2>Amendment of the Constitution</h2>
...
<p>flexibility is maintained.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (155, 21, 'Doctrine and Terms', 'doctrine-and-terms', '<h2>Doctrine and Terms</h2>
...
<p>constitutional values.</p>', 5);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (156, 21, 'Other Constitutional Dimensions', 'other-constitutional-dimensions', '<h2>Other Constitutional Dimensions</h2>
...
<p>and duties balance freedom. These dimensions ensure holistic governance.</p>', 6);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (157, 22, 'Articles 1--4', 'articles-1-4', '<h2>Articles 1--4</h2>
...
<p>structure supports governance.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (158, 23, 'Constitutional Provisions', 'constitutional-provisions', '<h2>Constitutional Provisions</h2>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (159, 23, 'CONSTITUTIONAL PROVISIONS OF CITIZENSHIP', 'constitutional-provisions-of-citizenship', '<h2>CONSTITUTIONAL PROVISIONS OF CITIZENSHIP</h2>
...
<p>like voting and contesting elections.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (160, 23, 'CITIZENSHIP ACT, 1955', 'citizenship-act-1955', '<h2>CITIZENSHIP ACT, 1955</h2>
...
<p>The Act supports India''s single citizenship system.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (161, 23, 'THE CITIZENSHIP (AMENDMENT) ACT, 2016', 'the-citizenship-amendment-act-2016', '<h2>THE CITIZENSHIP (AMENDMENT) ACT, 2016</h2>
...
<p>Act is important from a prelims factual perspective.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (162, 23, 'METHODOLOGY OF GETTING INDIAN CITIZENSHIP', 'methodology-of-getting-indian-citizenship', '<h2>METHODOLOGY OF GETTING INDIAN CITIZENSHIP</h2>
...
<p>constitutional sovereignty.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (163, 23, 'MODES OF LOSING INDIAN CITIZENSHIP', 'modes-of-losing-indian-citizenship', '<h2>MODES OF LOSING INDIAN CITIZENSHIP</h2>
<p>Indian citizenship can be lost in three ways under the Citizenship Act,</p>
<p>1955. Renunciation occurs when a citizen voluntarily gives up</p>
...
<p>factual area for prelims.</p>', 5);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (164, 23, 'CONCEPT OF DUAL CITIZENSHIP', 'concept-of-dual-citizenship', '<h2>CONCEPT OF DUAL CITIZENSHIP</h2>
...
<p>simplifies legal obligations. UPSC often tests this distinction.</p>', 6);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (165, 23, 'SPECIAL PRIVILEGES ENJOYED BY INDIAN CITIZENS', 'special-privileges-enjoyed-by-indian-citizens', '<h2>SPECIAL PRIVILEGES ENJOYED BY INDIAN CITIZENS</h2>
...
<p>aliens.</p>', 7);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (166, 23, 'RIGHTS AND DUTIES OF CITIZENS', 'rights-and-duties-of-citizens', '<h2>RIGHTS AND DUTIES OF CITIZENS</h2>
...
<p>important for conceptual clarity.</p>', 8);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (167, 23, 'Indian Diaspora', 'indian-diaspora', '<h2>Indian Diaspora</h2>', 9);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (168, 23, 'PRAVASI BHARATIYA DIVAS', 'pravasi-bharatiya-divas', '<h2>PRAVASI BHARATIYA DIVAS</h2>
...
<p>This topic is relevant for current affairs.</p>', 10);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (169, 23, 'NON-RESIDENT INDIANS (NRI)', 'non-resident-indians-nri', '<h2>NON-RESIDENT INDIANS (NRI)</h2>
...
<p>5.**FUNDAMENTAL RIGHTS**</p>', 11);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (170, 23, 'INDIAN DIASPORA', 'indian-diaspora', '<h2>INDIAN DIASPORA</h2>
...
<p>polity and current affairs perspectives.</p>', 12);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (171, 23, 'ARTICLE 12 AND ARTICLE 13', 'article-12-and-article-13', '<h2>ARTICLE 12 AND ARTICLE 13</h2>
...
<p>State power.</p>', 13);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (172, 23, 'RIGHT TO EQUALITY (ARTICLES 14--18)', 'right-to-equality-articles-14-18', '<h2>RIGHT TO EQUALITY (ARTICLES 14--18)</h2>
...
<p>Equality is a core democratic value of the Constitution.</p>', 14);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (173, 23, 'RIGHT TO FREEDOM (ARTICLES 19--22)', 'right-to-freedom-articles-19-22', '<h2>RIGHT TO FREEDOM (ARTICLES 19--22)</h2>
...
<p>to democratic governance.</p>', 15);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (174, 23, 'RIGHT AGAINST EXPLOITATION (ARTICLES 23--24)', 'right-against-exploitation-articles-23-24', '<h2>RIGHT AGAINST EXPLOITATION (ARTICLES 23--24)</h2>
...
<p>important from a human rights perspective.</p>', 16);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (175, 23, 'RIGHT TO FREEDOM OF RELIGION (ARTICLES 25--28)', 'right-to-freedom-of-religion-articles-25-28', '<h2>RIGHT TO FREEDOM OF RELIGION (ARTICLES 25--28)</h2>
...
<p>basic feature of the Constitution.</p>', 17);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (176, 23, 'CULTURAL AND EDUCATIONAL RIGHTS (ARTICLES 29--30)', 'cultural-and-educational-rights-articles-29-30', '<h2>CULTURAL AND EDUCATIONAL RIGHTS (ARTICLES 29--30)</h2>
...
<p>education. Minority rights strengthen democratic values.</p>', 18);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (177, 23, 'RIGHT TO CONSTITUTIONAL REMEDIES (ARTICLE 32)', 'right-to-constitutional-remedies-article-32', '<h2>RIGHT TO CONSTITUTIONAL REMEDIES (ARTICLE 32)</h2>
...
<p>constitutional supremacy.</p>', 19);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (178, 23, 'FUNDAMENTAL RIGHTS -- OTHER DIMENSIONS (ARTICLES 33--35)', 'fundamental-rights-other-dimensions-articles-33-35', '<h2>FUNDAMENTAL RIGHTS -- OTHER DIMENSIONS (ARTICLES 33--35)</h2>
...
<p>6\. **DIRECTIVE PRINCIPLES OF STATE POLICY (DPSP)**</p>', 20);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (179, 23, 'EVOLUTION, OBJECTIVES, AND FEATURES', 'evolution-objectives-and-features', '<h2>EVOLUTION, OBJECTIVES, AND FEATURES</h2>
...
<p>social democracy.</p>', 21);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (180, 23, 'SOCIALISTIC PRINCIPLES (DPSP)', 'socialistic-principles-dpsp', '<h2>SOCIALISTIC PRINCIPLES (DPSP)</h2>
...
<p>legislation.</p>', 22);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (181, 23, 'GANDHIAN PRINCIPLES (DPSP)', 'gandhian-principles-dpsp', '<h2>GANDHIAN PRINCIPLES (DPSP)</h2>
...
<p>strengthen grassroots democracy.</p>', 23);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (182, 23, 'LIBERAL--INTELLECTUAL PRINCIPLES (DPSP)', 'liberal-intellectual-principles-dpsp', '<h2>LIBERAL--INTELLECTUAL PRINCIPLES (DPSP)</h2>
...
<p>often tests identification and classification of these principles.</p>', 24);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (183, 23, 'DIRECTIVE PRINCIPLES OUTSIDE PART IV', 'directive-principles-outside-part-iv', '<h2>DIRECTIVE PRINCIPLES OUTSIDE PART IV</h2>
...
<p>practical implications in nation-building.</p>', 25);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (184, 24, 'Centre-State Relations:', 'centre-state-relations', '<h2>Centre-State Relations:</h2>
...
<p>competitive, and coercive federalism**.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (185, 24, 'Inter-State Relations:', 'inter-state-relations', '<h2>Inter-State Relations:</h2>
...
<p>262. Examples include the Cauvery water dispute and Krishna-Godavari</p>
...
<p>**federal balance and development issues**.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (186, 24, 'Special Provisions for Some States:', 'special-provisions-for-some-states', '<h2>Special Provisions for Some States:</h2>
...
<p>analytical understanding rather than rote facts.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (187, 24, 'Types of Emergencies:', 'types-of-emergencies', '<h2>Types of Emergencies:</h2>
...
<p>9\. **UNION EXECUTIVE**</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (188, 24, 'President:', 'president', '<h2>President:</h2>
...
<p>role as **a ceremonial head versus a constitutional authority**.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (189, 24, 'Vice President:', 'vice-president', '<h2>Vice President:</h2>
...
<p>matters can be an added edge.</p>', 5);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (190, 24, 'Prime Minister:', 'prime-minister', '<h2>Prime Minister:</h2>
...
<p>role in national security and international affairs** is also tested.</p>', 6);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (191, 24, 'Union Council of Ministers:', 'union-council-of-ministers', '<h2>Union Council of Ministers:</h2>
...
<p>10\. **UNION LEGISLATURE**</p>', 7);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (192, 24, 'Organisation of Parliament:', 'organisation-of-parliament', '<h2>Organisation of Parliament:</h2>
...
<p>procedural aspects**.</p>', 8);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (193, 24, 'Parliament, Lok Sabha, and Rajya Sabha:', 'parliament-lok-sabha-and-rajya-sabha', '<h2>Parliament, Lok Sabha, and Rajya Sabha:</h2>
...
<p>useful. UPSC seeks understanding of how bicameralism functions in India.</p>', 9);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (194, 24, 'Legislative Procedure and Committees of Parliament:', 'legislative-procedure-and-committees-of-parliament', '<h2>Legislative Procedure and Committees of Parliament:</h2>
...
<p>significance in effective governance**.</p>', 10);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (195, 25, 'Governor:', 'governor', '<h2>Governor:</h2>
...
<p>**activist vs. neutral roles**.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (196, 25, 'The Chief Minister and Council of Ministers:', 'the-chief-minister-and-council-of-ministers', '<h2>The Chief Minister and Council of Ministers:</h2>
...
<p>12\. **STATE LEGISLATURE**</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (197, 25, 'Legislative Assembly (Vidhan Sabha):', 'legislative-assembly-vidhan-sabha', '<h2>Legislative Assembly (Vidhan Sabha):</h2>
...
<p>and legislative procedures**.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (198, 25, 'Legislative Council (Vidhan Parishad) -- Article 169:', 'legislative-council-vidhan-parishad-article-169', '<h2>Legislative Council (Vidhan Parishad) -- Article 169:</h2>
...
<p>mere facts**.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (199, 26, 'Panchayati Raj:', 'panchayati-raj', '<h2>Panchayati Raj:</h2>
...
<p>planning** is important.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (200, 26, 'Urban Local Government:', 'urban-local-government', '<h2>Urban Local Government:</h2>
...
<p>14.**UNION TERRITORIES AND SPECIAL AREAS**</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (201, 26, 'Union Territories:', 'union-territories', '<h2>Union Territories:</h2>
...
<p>emphasizes clarity on **centre-UT relations and governance challenges**.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (202, 26, 'Scheduled and Tribal Areas:', 'scheduled-and-tribal-areas', '<h2>Scheduled and Tribal Areas:</h2>
...
<p>balanced development.**</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (203, 27, 'The Supreme Court:', 'the-supreme-court', '<h2>The Supreme Court:</h2>
...
<p>and maintaining federal balance**.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (204, 27, 'High Courts, Subordinate Courts & Lok Adalats:', 'high-courts-subordinate-courts-lok-adalats', '<h2>High Courts, Subordinate Courts & Lok Adalats:</h2>
...
<p>judicial hierarchy, efficiency, and justice delivery reforms.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (205, 28, 'Constitutional Bodies:', 'constitutional-bodies', '<h2>Constitutional Bodies:</h2>
...
<p>important. UPSC expects conceptual clarity rather than memorization.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (206, 28, 'Non-Constitutional Bodies:', 'non-constitutional-bodies', '<h2>Non-Constitutional Bodies:</h2>
...
<p>implementation**.</p>
<p>**ECONOMY\</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (207, 29, 'Macroeconomic Concepts', 'macroeconomic-concepts', '<h2>Macroeconomic Concepts</h2>
...
<p>is essential to analyze India''s economic policies and global trends.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (208, 29, 'Microeconomic Concepts', 'microeconomic-concepts', '<h2>Microeconomic Concepts</h2>
...
<p>**2.ECONOMIC MEASUREMENTS\</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (209, 29, 'National Income Concepts and Methods of Calculation', 'national-income-concepts-and-methods-of-calculation', '<h2>National Income Concepts and Methods of Calculation</h2>
...
<p>]{.underline}**</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (210, 29, 'Economic Growth and Development', 'economic-growth-and-development', '<h2>Economic Growth and Development</h2>
...
<p>between growth and development.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (211, 29, 'Inflation', 'inflation', '<h2>Inflation</h2>
...
<p>inflation.**\</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (212, 29, 'Money Function and Classification', 'money-function-and-classification', '<h2>Money Function and Classification</h2>
...
<p>interventions for stability**.**</p>', 5);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (213, 29, 'Financial Market and Its Instruments', 'financial-market-and-its-instruments', '<h2>Financial Market and Its Instruments</h2>
...
<p>instruments to analyze current developments.</p>', 6);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (214, 29, 'Banking Structure in India', 'banking-structure-in-india', '<h2>Banking Structure in India</h2>
...
<p>**4.PUBLIC FINANCE IN INDIA\</p>', 7);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (215, 29, 'Budgeting', 'budgeting', '<h2>Budgeting</h2>
...
<p>fiscal indicators, and policy priorities.</p>', 8);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (216, 29, 'Centre--State Distribution', 'centre-state-distribution', '<h2>Centre--State Distribution</h2>
...
<p>mechanism is vital to analyze fiscal federalism.</p>', 9);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (217, 29, 'Fiscal Policy', 'fiscal-policy', '<h2>Fiscal Policy</h2>
...
<p>central to understanding governance**.**</p>', 10);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (218, 29, 'Tax Structure in India (Meaning, Objectives and History)', 'tax-structure-in-india-meaning-objectives-and-history', '<h2>Tax Structure in India (Meaning, Objectives and History)</h2>
...
<p>policy**.\</p>', 11);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (219, 29, 'Five Year Plans in India', 'five-year-plans-in-india', '<h2>Five Year Plans in India</h2>
...
<p>shaped India''s development trajectory. Though discontinued, they remain</p>', 12);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (220, 29, 'Meaning Objectives and History', 'meaning-objectives-and-history', '<h2>Meaning Objectives and History</h2>
...
<p>and governance.</p>', 13);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (221, 30, 'Foreign Trade Concepts', 'foreign-trade-concepts', '<h2>Foreign Trade Concepts</h2>
...
<p>to understand India''s external sector.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (222, 30, 'Trade Policy and Agreements', 'trade-policy-and-agreements', '<h2>Trade Policy and Agreements</h2>
...
<p>India''s trade agreements and their impact on the economy.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (223, 30, 'Exchange Rate', 'exchange-rate', '<h2>Exchange Rate</h2>
...
<p>impact on India''s economy is essential.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (224, 30, 'Trade Agreements', 'trade-agreements', '<h2>Trade Agreements</h2>
...
<p>trade agreements and their implications.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (225, 30, 'International Organizations', 'international-organizations', '<h2>International Organizations</h2>
...
<p>analyze India''s external relations.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (226, 30, 'Recent Developments in External Sector', 'recent-developments-in-external-sector', '<h2>Recent Developments in External Sector</h2>
...
<p>understanding India''s global position.</p>', 5);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (227, 31, 'Poverty', 'poverty', '<h2>Poverty</h2>
...
<p>For UPSC, poverty is a recurring theme in GS papers and essays.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (228, 31, 'Employment', 'employment', '<h2>Employment</h2>
...
<p>issues are central to GS Paper III and essay writing.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (229, 31, 'Government Schemes and Programs', 'government-schemes-and-programs', '<h2>Government Schemes and Programs</h2>
...
<p>GS answers and current affairs.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (230, 31, 'Committees', 'committees', '<h2>Committees</h2>
...
<p>helps analyze the evolution of India''s economic policies**.**</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (231, 31, 'Science and Technology', 'science-and-technology', '<h2>Science and Technology</h2>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (232, 32, 'Different Organizations, Institutions, and Departments for S&T', 'different-organizations-institutions-and-departments-for-st', '<h2>Different Organizations, Institutions, and Departments for S&T</h2>
...
<p>India''s S&T framework.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (233, 33, 'Space Research Programme, Orbits and Launch', 'space-research-programme-orbits-and-launch', '<h2>Space Research Programme, Orbits and Launch</h2>
...
<p>national development.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (234, 33, 'Satellites, Launch Vehicles and India''s Satellite Programmes', 'satellites-launch-vehicles-and-indias-satellite-programmes', '<h2>Satellites, Launch Vehicles and India''s Satellite Programmes</h2>
...
<p>solutions.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (235, 34, 'Different Regulatory Bodies in India for ICT', 'different-regulatory-bodies-in-india-for-ict', '<h2>Different Regulatory Bodies in India for ICT</h2>
...
<p>CERT-In is crucial as they form the backbone of India''s ICT governance.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (236, 34, 'Computer Terminology and Fundamentals', 'computer-terminology-and-fundamentals', '<h2>Computer Terminology and Fundamentals</h2>
...
<p>and e-governance.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (237, 34, 'Mobile Generations and Technology', 'mobile-generations-and-technology', '<h2>Mobile Generations and Technology</h2>
...
<p>economic growth.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (238, 34, 'Internet, Types of Network and e-Governance', 'internet-types-of-network-and-e-governance', '<h2>Internet, Types of Network and e-Governance</h2>
...
<p>reflect the role of ICT in governance and development.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (239, 34, 'Spectrum Policy and Broadband Policy', 'spectrum-policy-and-broadband-policy', '<h2>Spectrum Policy and Broadband Policy</h2>
...
<p>India''s digital economy.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (240, 35, 'Superconductivity, Laser, and Artificial Intelligence', 'superconductivity-laser-and-artificial-intelligence', '<h2>Superconductivity, Laser, and Artificial Intelligence</h2>
...
<p>development and global competitiveness.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (241, 35, 'Nanotechnology', 'nanotechnology', '<h2>Nanotechnology</h2>
...
<p>advanced technology.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (242, 36, 'Defence Technology', 'defence-technology', '<h2>Defence Technology</h2>
...
<p>competitiveness.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (243, 36, 'Submarines', 'submarines', '<h2>Submarines</h2>
...
<p>submarines offer greater endurance and stealth. India''s</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (244, 36, 'Sindhughosh-class (Kilo-class) and Shishumar-class (HDW-class)', 'sindhughosh-class-kilo-class-and-shishumar-class-hdw-class', '<h2>Sindhughosh-class (Kilo-class) and Shishumar-class (HDW-class)</h2>
...
<p>depth, and maritime strength in the 21st century.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (245, 37, 'Nuclear Energy and Nuclear Fuels', 'nuclear-energy-and-nuclear-fuels', '<h2>Nuclear Energy and Nuclear Fuels</h2>
...
<p>nuclear energy in sustainable development.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (246, 37, 'Nuclear Programme in India', 'nuclear-programme-in-india', '<h2>Nuclear Programme in India</h2>
...
<p>India''s balance between civilian energy needs and strategic security.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (247, 37, 'Organisations and Institutions', 'organisations-and-institutions', '<h2>Organisations and Institutions</h2>
...
<p>BARC, NPCIL, IGCAR, UCIL, HWB, and BRIT.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (248, 37, 'Radioactivity', 'radioactivity', '<h2>Radioactivity</h2>
...
<p>regulatory framework for radiation protection.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (249, 38, 'Intellectual Property Rights (IPR)', 'intellectual-property-rights-ipr', '<h2>Intellectual Property Rights (IPR)</h2>
...
<p>Patents, Designs, and Trade Marks (CGPDTM)** administers IPR, while the</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (250, 38, 'Department for Promotion of Industry and Internal Trade (DPIIT)', 'department-for-promotion-of-industry-and-internal-trade-dpiit', '<h2>Department for Promotion of Industry and Internal Trade (DPIIT)</h2>
...
<p>national competitiveness, creativity, and sustainable growth.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (251, 39, 'Biotechnology in India', 'biotechnology-in-india', '<h2>Biotechnology in India</h2>
...
<p>biotechnology in national development.</p>', 0);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (252, 39, 'Genetics and Biotechnology', 'genetics-and-biotechnology', '<h2>Genetics and Biotechnology</h2>
...
<p>applications in health, agriculture, and environment.</p>', 1);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (253, 39, 'Biological Fuel Generation', 'biological-fuel-generation', '<h2>Biological Fuel Generation</h2>
...
<p>energy.</p>', 2);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (254, 39, 'Environmental Biotechnology', 'environmental-biotechnology', '<h2>Environmental Biotechnology</h2>
...
<p>control, waste management, and sustainable development.</p>', 3);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (255, 39, 'Plant and Forest Biotechnology', 'plant-and-forest-biotechnology', '<h2>Plant and Forest Biotechnology</h2>
...
<p>role in forestry and conservation.</p>', 4);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (256, 39, 'Animal and Insect Biotechnology', 'animal-and-insect-biotechnology', '<h2>Animal and Insect Biotechnology</h2>
...
<p>pest management.</p>', 5);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (257, 39, 'Food and Beverage Biotechnology', 'food-and-beverage-biotechnology', '<h2>Food and Beverage Biotechnology</h2>
...
<p>regulatory framework for food safety.</p>', 6);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (258, 39, 'Protection of Biotechnological Inventions', 'protection-of-biotechnological-inventions', '<h2>Protection of Biotechnological Inventions</h2>
...
<p>agreement, and India''s measures against biopiracy.</p>', 7);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (259, 39, 'Recent Developments in Biotechnology', 'recent-developments-in-biotechnology', '<h2>Recent Developments in Biotechnology</h2>
...
<p>initiatives, and their societal impact.</p>', 8);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (260, 39, 'BIOLOGY', 'biology', '<h2>BIOLOGY</h2>', 9);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (261, 39, 'Origin of Life and Cells', 'origin-of-life-and-cells', '<h2>Origin of Life and Cells</h2>
...
<p>science perspective.</p>', 10);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (262, 39, 'Genetics', 'genetics', '<h2>Genetics</h2>
...
<p>relevant for UPSC Prelims basic science questions.</p>', 11);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (263, 39, 'Classification of Living Things', 'classification-of-living-things', '<h2>Classification of Living Things</h2>
...
<p>and is relevant for UPSC Prelims.</p>', 12);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (264, 39, 'Evolution of Life', 'evolution-of-life', '<h2>Evolution of Life</h2>
...
<p>factual questions on theories, scientists, and evolutionary mechanisms.</p>', 13);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (265, 39, 'Tissues', 'tissues', '<h2>Tissues</h2>
...
<p>functions is important for UPSC Prelims basic biology questions.</p>', 14);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (266, 39, 'Endocrine system', 'endocrine-system', '<h2>Endocrine system</h2>
...
<p>thyroid diseases. Knowledge of glands, hormones, and functions.</p>', 15);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (267, 39, 'Respiratory System', 'respiratory-system', '<h2>Respiratory System</h2>
...
<p>essential for energy production and survival.</p>', 16);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (268, 39, 'The Transport System in Organisms', 'the-transport-system-in-organisms', '<h2>The Transport System in Organisms</h2>
...
<p>system is essential for maintaining internal balance and survival.</p>', 17);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (269, 39, 'Skeletal and Muscular Systems', 'skeletal-and-muscular-systems', '<h2>Skeletal and Muscular Systems</h2>
...
<p>muscles enables posture, locomotion, and daily activities.</p>', 18);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (270, 39, 'Reproductive System', 'reproductive-system', '<h2>Reproductive System</h2>
...
<p>aspects.</p>', 19);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (271, 39, 'Excretory System', 'excretory-system', '<h2>Excretory System</h2>
...
<p>the excretory system is essential for homeostasis.</p>', 20);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (272, 39, 'Nutrition', 'nutrition', '<h2>Nutrition</h2>
...
<p>amounts. Nutrition is essential for immunity and overall health.</p>', 21);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (273, 39, 'Diseases', 'diseases', '<h2>Diseases</h2>
...
<p>control.</p>', 22);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (274, 39, 'Economic Zoology', 'economic-zoology', '<h2>Economic Zoology</h2>
...
<p>zoology links biodiversity with human welfare.</p>', 23);
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (275, 39, 'Recent Development', 'recent-development', '<h2>Recent Development</h2>
...
<p>highlights India''s commitment to sustainable development.</p>', 24);
-- CSAT CONTENT PATCH
-- Add content to CSAT topics (which currently have 0 items)

-- Interpersonal Skills (topic_id = 40)
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (
276, 40, 
'Interpersonal Skills including Communication Skills',
'interpersonal-skills-including-communication-skills',
'<h2>Interpersonal Skills including Communication Skills</h2><p>Interpersonal skills in CSAT focus on how candidates interact effectively in professional and social contexts. The syllabus expects aspirants to understand clarity of thought, empathy, and active listening. Communication skills are tested through comprehension passages and situational questions. Candidates learn how to interpret tone, intent, and context in conversations. They must demonstrate the ability to persuade, negotiate, and resolve conflicts constructively. The exam emphasizes teamwork and cooperation, reflecting administrative realities. It also highlights the importance of non-verbal communication like body language and gestures. Aspirants practice framing responses that are concise yet impactful. Ethical communication is stressed, ensuring honesty and transparency. The ability to adapt communication styles to different audiences is tested. Candidates must show sensitivity to cultural and social diversity. Effective communication is linked to leadership qualities. The syllabus ensures aspirants can handle citizen grievances with empathy. Overall, this section prepares them to be approachable, clear, and trustworthy administrators.</p>',
0);

-- Logical Reasoning (topic_id = 41)
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (
277, 41,
'Logical Reasoning and Analytical Ability',
'logical-reasoning-and-analytical-ability',
'<h2>Logical Reasoning and Analytical Ability</h2><p>Logical reasoning in CSAT trains aspirants to identify patterns, evaluate arguments, and draw valid conclusions. Analytical ability questions include puzzles, syllogisms, analogies, and logical sequences. Candidates learn to eliminate irrelevant data and focus on essentials. The syllabus emphasizes structured problem-solving approaches. It tests clarity of thought under pressure. Aspirants practice reasoning through cause-effect relationships. They must analyze statements and assumptions critically. Logical deductions are often tested through seating arrangements or direction problems. Analytical ability also includes identifying inconsistencies in arguments. Candidates learn to apply reasoning to governance scenarios. The exam ensures aspirants can think rationally in complex situations. Logical clarity is linked to decision-making in administration. This section strengthens mental agility and precision. It prepares candidates to evaluate policies and arguments objectively. Overall, it ensures civil servants can reason soundly and act decisively.</p>',
0);

-- Decision Making (topic_id = 42)
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (
278, 42,
'Decision Making and Problem Solving',
'decision-making-and-problem-solving',
'<h2>Decision Making and Problem Solving</h2><p>Decision making in CSAT evaluates judgment, integrity, and fairness. Situational questions present dilemmas requiring ethical and practical solutions. Aspirants must balance competing interests and prioritize resources. The syllabus emphasizes transparency and citizen-centric choices. Candidates learn to resolve conflicts with impartiality. Problem-solving skills are tested through scenarios requiring quick action. The exam highlights the importance of accountability in decisions. Ethical reasoning is central, ensuring aspirants act responsibly. Candidates practice weighing short-term vs long-term impacts. They must show adaptability in uncertain situations. The syllabus links decision making with governance challenges. It ensures aspirants can handle crises effectively. Problem solving also tests creativity in finding solutions. Candidates learn to apply logical frameworks to real issues. Overall, this section prepares them for leadership roles requiring sound judgment.</p>',
0);

-- General Mental Ability (topic_id = 43)
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (
279, 43,
'General Mental Ability',
'general-mental-ability',
'<h2>General Mental Ability</h2><p>General mental ability covers a wide range of aptitude skills. Candidates practice coding-decoding, directions, and series completion. Seating arrangement problems test spatial reasoning. Analytical puzzles strengthen logical clarity. The syllabus emphasizes quick thinking and accuracy. Aspirants learn to apply structured approaches to solve problems. Mental agility is tested through diverse question types. Candidates must adapt to unfamiliar patterns. The exam ensures aspirants can process information rapidly. General mental ability reflects everyday problem-solving skills. It prepares candidates for administrative multitasking. Logical clarity is linked to efficiency in governance. The syllabus ensures aspirants can think under pressure. Practice improves speed and confidence. Overall, this section builds the foundation for aptitude and reasoning.</p>',
0);

-- Basic Numeracy (topic_id = 44)
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (
280, 44,
'Basic Numeracy',
'basic-numeracy',
'<h2>Basic Numeracy (Class X Level)</h2><p>Basic numeracy in CSAT tests arithmetic skills at Class X level. Candidates practice numbers, ratios, and percentages. Averages and orders of magnitude are emphasized. Profit and loss problems test commercial understanding. Time and work questions assess efficiency. Speed, distance, and time problems test logical application. Simple and compound interest questions are included. The syllabus ensures accuracy in quantitative reasoning. Candidates must apply math to real-life scenarios. Numeracy reflects financial and administrative calculations. The exam emphasizes precision and speed. Aspirants learn shortcuts for quick problem solving. Practice builds confidence in handling numbers. The syllabus ensures aspirants can manage budgets and data. Overall, numeracy prepares them for quantitative aspects of governance.</p>',
0);

-- Data Interpretation (topic_id = 45)
INSERT INTO content (id, topic_id, title, slug, content_body, order_index) VALUES (
281, 45,
'Data Interpretation',
'data-interpretation',
'<h2>Data Interpretation (Class X Level)</h2><p>Data interpretation tests the ability to analyze charts, graphs, and tables. Candidates must extract relevant information quickly. They learn to identify trends and patterns. Data sufficiency problems test logical conclusions. The syllabus emphasizes accuracy in analysis. Aspirants practice interpreting percentages and ratios in data sets. Graphical problems test visual reasoning. Tables require careful reading and comparison. Candidates must avoid misinterpretation of figures. The exam ensures aspirants can handle statistical data. Data interpretation reflects governance tasks like policy analysis. It prepares candidates for evidence-based decision making. The syllabus links numbers with real-world implications. Practice improves speed and precision. Overall, this section ensures aspirants can analyze data for effective administration.</p>',
0);